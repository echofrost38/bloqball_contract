...
// File: contracts/interfaces/IBloqBallLottery.sol



pragma solidity ^0.8.0;

interface IBloqBallLottery {
    /**
...
// File: contracts/RandomGenerator.sol
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public bloqballSwapLottery;
     ...
     * BSC testnet
     * LINK             0xfaFedb041c0DD4fA2Dc0d87a6B0979Ee6FA7af5F
     ...
     * @param _seed: seed provided by the bloqballSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == bloqballSwapLottery, "Only bloqballSwap Lottery");
    ...
    /**
     * @notice Set the address for the bloqballSwap Lottery
     * @param _bloqballSwapLottery: address of the bloqballSwap lottery
     */
    function setLotteryAddress(address _bloqballSwapLottery) external onlyOwner {
        bloqballSwapLottery = _bloqballSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IBloqBallLottery(bloqballSwapLottery).viewCurrentLotteryId();
    }
}